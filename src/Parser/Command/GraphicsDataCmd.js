...
const PrintBufferredDataGraphicsSubCmd = require('./PrintBufferredDataGraphicsSubCmd')
const StoreRasterFmtDataToPrintBufferGraphicsSubCmd = require('./StoreRasterFmtDataToPrintBufferGraphicsSubCmd')
const StoreColumnFmtDataToPrintBufferGraphicsSubCmd = require('./StoreColumnFmtDataToPrintBufferGraphicsSubCmd')

class GraphicsDataCmd extends DataCmd {
  getSubCommand(m, fn, len) {
  ...
  static subCommandLookup(m, fn, len) {
    if (fn === 0 || fn === 48) {
...
module.exports = GraphicsDataCmd
